...
def main():
    ...
    if use_dual:
        ...
        converter = utils.CTCLabelConverter(''.join(train_dataset.ralph.values()) if isinstance(train_dataset.ralph, dict) else train_dataset.ralph)
