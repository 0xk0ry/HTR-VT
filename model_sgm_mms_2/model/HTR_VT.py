...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, x, use_masking=False, return_features=False, mask_mode="mms", mask_ratios=None, max_span_length=None):
        feats = self.forward_features(
            x, use_masking=use_masking, mask_mode=mask_mode, mask_ratios=mask_ratios, max_span_length=max_span_length)  # [B, N, D]
