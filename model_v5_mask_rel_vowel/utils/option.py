...
def get_args_parser():
    """
    Create and return the argument parser for HTR training and evaluation.
    Returns:
    ...
    parser.add_argument('--vowel-only-tags', action='store_true', default=False,
                        help='If set, only supervise modifier/tone heads on vowels (consonants forced to none/level)')
    ...
    parser.add_argument('--lambda-mod', default=0.5, type=float,
