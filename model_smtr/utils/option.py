...
def get_args_parser():
    ...
    parser.add_argument("--smtr-samples", type=int, default=24, help="substrings per line")
    parser.add_argument("--smtr-lambda", type=float, default=0.3, help="loss weight")
    parser.add_argument("--smtr-rand-replace-p", type=float, default=0.3,
