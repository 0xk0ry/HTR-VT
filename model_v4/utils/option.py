...
def get_args_parser():
    ...
    parser.add_argument('--alpha-ctc', default=1.0, type=float,
                        help='Weight for CTC loss (base characters)')
    parser.add_argument('--alpha-diac', default=1.0, type=float,
                        help='Weight for diacritic cross-entropy loss')
